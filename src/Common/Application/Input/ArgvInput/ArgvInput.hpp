...
namespace Common::Console
{
    ...
    public:
        ...
        ArgvInput(int argc, char const *argv[], std::istream & istream);
        ArgvInput(std::unique_ptr<ArgsContainer> container, std::istream & istream)
        : AbstractInput(istream), m_tokens(std::move(container)) {}
